...
<header>
    ...
    <h1 align="left"><b>WELCOME TO MY TRANSLATORS BUREAU                </b> <a class="myButton" href="${pageContext.request.contextPath}/orders">  ПРОСМОТРЕТЬ ВСЕ ЗАКАЗЫ </a>
    </h1>
    <ul id="menu">
        ...
        <li><a href="${pageContext.request.contextPath}/aboutUs">О нас</a>
            <ul>
                <li><a href="${pageContext.request.contextPath}/contacts">Наши контакты</a></li>
                <li><a href="${pageContext.request.contextPath}/ourTranslators">Наши переводчики</a></li>
                <li><a href="${pageContext.request.contextPath}/FAQ">FAQ</a></li>
            </ul>
        </li>
        <li><a href="#">Отзывы</a></li>
        <li><a href="${pageContext.request.contextPath}/createTranslator"> Создать переводчика</a></li>
    </ul>
</header>
